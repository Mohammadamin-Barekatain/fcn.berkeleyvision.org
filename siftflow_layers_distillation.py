...
class SIFTFlowSegDataLayer(caffe.Layer):
    ...
    def load_label(self, idx, label_type=None):
        ...
        if label_type == 'semantic':
            label = scipy.io.loadmat('{}/../../siftflow-distilled/score_sem/{}.mat'.format(self.siftflow_dir, idx))['S']
        elif label_type == 'geometric':
            label = scipy.io.loadmat('{}/../../siftflow-distilled/score_geo/{}.mat'.format(self.siftflow_dir, idx))['S']
        else:
